...
<div class="row">
	<div class="col">
		<table>
			<tr><td>Perihal</td><td>: Laporan Reservasi</td></tr>
			<tr><td>Dari Tanggal</td><td>: {{$tool->dateformat($dari,'D, d M Y')}}</td></tr>
			<tr><td>Sampai Tanggal</td><td>: {{$tool->dateformat($sampai,'D, d M Y')}}</td></tr>
		</table>
	</div>
	<div class="col">
		<table>
...
<table class="table mt-3 table-striped">
	...
	<tr>
		...
		<td>
			Rute : {{$field->rute_from}} -> {{$field->rute_to}} <br>
