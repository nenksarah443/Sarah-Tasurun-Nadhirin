	...
	<div class="card-body">
		...
		{{csrf_field()}}
			...
			<div class="form-group">
				...
				<div class="row">
					<div class="col-sm-4" style="background-image: url('images/kereta 3.jpg')">
						<select class="form-control {{$errors->has('tipe')?'is-invalid':''}}" name="tipe" required autofocus>
							...
							?>
							@foreach($res as $opt)
							<option value="{{$opt->id}}" {{$val==$opt->id?'selected':''}}>{{$opt->description}}
							</option>
							@endforeach
						</select>
			...
			<div class="form-group">
				...
				<div class="row">
					<div class="col-sm-6"  >
						<input type="text" name="kode" class="form-control {{$errors->has('kode')?'is-invalid':''}}" value="{{ Request::old('kode') }}" required  />
				...
				<small>
					Panjang Karakter 3-50, Contoh : Argo Wilis
				</small>
			</div>
			...
			<div class="form-group">
				...
				<small>
					Panjang Karakter 3-50, Contoh : PT. Merah Putih
				</small>
			</div>
			...
			<div class="form-group">
				...
				<div class="row">
					<div class="col-sm-2">
						<input type="number" name="kapasitas" class="form-control {{$errors->has('kapasitas')?'is-invalid':''}}" value="{{ Request::old('kapasitas') }}" required autofocus />
