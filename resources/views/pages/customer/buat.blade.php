...
@section('content')
<h1>Laporan <small>Customer</small></h1>
<hr>
...
<div class="card border-info mb-3">
	...
	<div class="card-body bg-primary ">
		<form method="post" action="{{route('customer.render')}}">
		{{csrf_field()}}
			...
			<div class="form-row">
				...
				<div class="row">
					<div class="col-sm-8">
						<input type="text" name="alamat" class="form-control {{$errors->has('alamat')?'is-invalid':''}}" value="{{ Request::old('alamat') }}" autofocus />
				...
				<small>
					Panjang Karakter 2-50, Contoh : Banjarsari
				</small>
			</div>
