@extends('layouts.main')
 ...
 @section('content')
	...
	<center><img src="{{url('images/ssuka.png')}}" height="80"></center>
		<center><h1><marquee><p>Welcome to airplane and train tickets !</p></h1></marquee></center>
